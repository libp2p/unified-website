...
weight = 11
aliases = ["/concepts/addressing", "/concepts/fundamentals/addressing"]
...
{% alert(type="tip") %}
For more on peer identity and its relation to public key cryptography, see [Peer Identity](/guides/peers/#peer-id).
{% end %}
