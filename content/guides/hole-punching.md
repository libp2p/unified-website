...
weight = 53
aliases = ["/concepts/hole-punching", "/concepts/nat/hole-punching"]
...
1. [AutoNAT](/guides/autonat/): Determine whether a node is dialable,
...
3. [Circuit Relay](/guides/circuit-relay/): Connect to and request
...
1. [Circuit Relay](/guides/circuit-relay/): Establish a secure relay connection
