...
weight = 13
aliases = ["/concepts/protocols", "/concepts/fundamentals/protocols"]
...
using the core libp2p abstractions like transport, [peer identity](/guides/peers/#peer-id), [addressing](/guides/addressing/), and so on.
...
information about themselves, such as their public key, which is used to derive their [PeerId](/guides/peers/).
