...
weight = 3
aliases = ["/tutorials/javascript", "/guides/javascript", "/guides/getting-started/javascript"]
...
Looking at the [available stream multiplexing](https://github.com/libp2p/js-libp2p/blob/master/doc/CONFIGURATION.md#stream-multiplexing) modules, js-libp2p supports `@chainsafe/libp2p-yamux` and `@libp2p/mplex`, but [mplex](/guides/mplex/) is [deprecated](https://github.com/libp2p/specs/issues/553) so we will use [Yamux](/guides/yamux/) here. You can install `@chainsafe/libp2p-yamux` and add it to your libp2p node as follows in the next example.
