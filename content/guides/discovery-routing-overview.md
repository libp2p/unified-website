...
weight = 70
aliases = ["/concepts/discovery-routing"]
...
[multiaddresses](/guides/addressing/) over the
...
- [Rendezvous](/guides/rendezvous/): a protocol that allows peers to exchange peer multiaddresses
  in a secure and private manner.
- [mDNS](/guides/mdns/): a multicast Domain Name System (DNS) protocol that allows peers to
  discover other peers on the local network.
- [DHT](/guides/kademlia-dht/): Distributed Hash Table, libp2p uses a DHT called Kademlia, it assigns
