...
weight = 40
aliases = ["/concepts/stream-multiplexing", "/concepts/multiplex"]
...
Currently, libp2p supports two stream muxers, [mplex](/guides/mplex/)
and [yamux](/guides/yamux/). However, many of the
[transport protocols](/guides/transports-overview/) available in the libp2p stack
come with native streams, such as [QUIC](/guides/quic/),
[WebTransport](/guides/webtransport/), and
[WebRTC](/guides/webrtc/), and in these cases, libp2p
