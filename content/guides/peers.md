...
weight = 12
aliases = ["/concepts/peers", "/concepts/fundamentals/peers", "/concepts/peer-id", "/concepts/fundamentals/peer-id"]
...
For more on addresses in libp2p, see [Addressing](/guides/addressing/).
