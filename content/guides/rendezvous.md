...
weight = 73
aliases = ["/concepts/discovery-routing/rendezvous"]
...
[DHT](/guides/kademlia-dht/) is a distributed network protocol used to store and
...
[Gossipsub](/guides/pubsub/), on the other hand, is a pub-sub (publish-subscribe) protocol
...
For effective discovery, rendezvous can be combined with [libp2p publish/subscribe](/guides/pubsub/).
