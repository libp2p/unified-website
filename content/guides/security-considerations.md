...
weight = 15
aliases = ["/concepts/security-considerations", "/concepts/security/security-considerations"]
...
Every libp2p peer is uniquely identified by their [Peer ID](/guides/peers/#peer-id), which
...
Your [protocol handler](/guides/protocols/#handler-functions) could then
...
libp2p's [publish/subscribe protocol](/guides/pubsub/) allows a peer
