...
weight = 43
aliases = ["/concepts/multiplex/early-negotiation"]
...
handshake. libp2p currently supports [Noise](/guides/noise/) and [TLS 1.3](/guides/tls/).
Once the cryptographic handshake completes, multistream-select runs again on top of
the secured connection to negotiate a steam multiplexer, like [yamux](/guides/yamux/) or [mplex](/guides/mplex/).
