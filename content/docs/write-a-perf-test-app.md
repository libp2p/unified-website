...
description = "Learn how to create a libp2p application that can be tested with the performance benchmarking test suite."
weight = 82
aliases = ["/guides/write-a-perf-test-app/"]
