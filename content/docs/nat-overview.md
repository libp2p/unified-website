...
weight = 50
aliases = ["/concepts/nat", "/guides/nat-overview/"]
...
The internet is composed of countless networks, bound together into shared address spaces by foundational [transport protocols](/docs/transports-overview/).
