...
weight = 51
aliases = ["/concepts/autonat", "/concepts/nat/autonat", "/guides/autonat/"]
...
> relay server to communicate with other nodes in the network.
...
with the same faked MAPPED-ADDRESS
