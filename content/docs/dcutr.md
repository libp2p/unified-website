...
weight = 54
aliases = ["/concepts/nat/dcutr", "/guides/dcutr/"]
...
connections. [Hole punching](/docs/hole-punching/) is another technique
...
[QUIC](/docs/quic/), the process of establishing a connection is
