...
description = "Learn how to create a libp2p application that can be tested with the hole-punch interoperability test suite."
weight = 83
aliases = ["/guides/write-a-hole-punch-test-app/"]
