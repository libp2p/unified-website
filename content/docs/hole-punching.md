+++
title = "Hole Punching"
description = "The internet is composed of countless networks, bound together into shared address spaces by foundational transport protocols. As traffic moves between network boundaries, it's very common for a process called Network Address Translation to occur."
weight = 53
aliases = ["/concepts/hole-punching", "/concepts/nat/hole-punching", "/guides/hole-punching/"]
...
1. [AutoNAT](/docs/autonat/): Determine whether a node is dialable,
...
3. [Circuit Relay](/docs/circuit-relay/): Connect to and request
...
1. [Circuit Relay](/docs/circuit-relay/): Establish a secure relay connection
