...
weight = 12
aliases = ["/concepts/peers", "/concepts/fundamentals/peers", "/concepts/peer-id", "/concepts/fundamentals/peer-id", "/guides/peers/"]
...
secure communication channels with each other.
...
A Peer ID can be encoded into a multiaddr as a `/p2p`
...
For more on addresses in libp2p, see [Addressing](/docs/addressing/).
...
Peer Info combines a Peer ID with a set of multiaddrs
